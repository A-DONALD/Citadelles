...
public class Voleur extends Personnage{
    ...
    public void utiliserPouvoir() {
        if(this.isValid()){
            ...
            System.out.println("Le personnage " + this.getPlateau().getPersonnage(choix - 1).getNom() + "a �t� vol�.");
        }
    }
    public void utiliserPouvoirAvatar() {
        if(this.isValid()){
            ...
            System.out.println("Le personnage " + this.getPlateau().getPersonnage(choix).getNom() + "a �t� vol�.");
        }
    }

...
import donald.fr.modele.Assassin;
import donald.fr.modele.Condottiere;
import donald.fr.modele.Roi;
import donald.fr.modele.Voleur;

import donald.fr.modele.Joueur;
import donald.fr.modele.Pioche;
import donald.fr.modele.PlateauDeJeu;
...
public class TestCondottiere {
    ...
    public void test1() {
        ...
        Test.test(plateau.getPersonnage(0)==condottiere,
                "recuperation du personnage du condottiere");

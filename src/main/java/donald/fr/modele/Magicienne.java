...
public class Magicienne extends Personnage {
    ...
    public void utiliserPouvoir() {
        if(this.isValid() && this.getJoueur().nbQuartiersDansMain()!=0) {
            System.out.println("Voulez-vous �changer vos cartes avec :\n1 - un autre joueur\n2 - la pioche");
            ...
            if (echangeAvecJoueur==1) {
                ...
                System.out.println("Echange �ffectu� par la magicienne avec " + this.getPlateau().getJoueur(choix - 1).getNom());
            }
            else{
                ...
                if(nb==0){
                    System.out.println("La magicienne n'effectue aucun changement n'a �t� �ffectu�");
                }
                    ...
                    for (int j = 0; j<nb; j++) {
                        // afficher toutes le cartes de la main � chaque iteration
                        for (int i = 0; i < copieMainMagicienne.size(); i++) {
    ...
    public void utiliserPouvoirAvatar() {
        if(this.isValid() && this.getJoueur().nbQuartiersDansMain()!=0){
            ...
            if(choix==0) {
                ...
                System.out.println("Echange �ffectu� par la magicienne avec " + this.getPlateau().getJoueur(choix).getNom());
            }
            else if (choix==1) {
                // echange avec pioche
